...
def mesh_volume(volume):
    ...
    params.subdomain = np.array([[1, 2.0], [2, 1.5]])  # region 1, 0.5mm; tumour, 0.3mm
...
def run_tpsf_simulation(mesh, total_time=10e-9, dt=1e-11, beautify=True, save_as="tpsf_plot.png"):
    """
